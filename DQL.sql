...
/* =================================================================================
   VTYS-1 DÖNEM PROJESÝ: Geliþmiþ Programlanabilirlik Nesneleri Scripti [cite: 2, 33]
   ================================================================================= */
USE YemekSiparisDB;
GO
...
SELECT 
    ...
    -- NULLIF kullanýmý: Eðer restoranýn sipariþi 0 ise sýfýra bölünme hatasýný (Divide by Zero) engeller.
...
-- [GRUPLAMA]: Agregasyon fonksiyonlarýnýn hangi kýrýlýmda (restoran bazýnda) hesaplanacaðýný belirler
GROUP BY R.RestoranID, R.RestoranAdi
-- [HAVING FILTRESI]: Gruplama yapýldýktan sonra, sadece hoca kýlavuzundaki gibi 5 ve üzeri sipariþ alan popüler yerleri seçer
